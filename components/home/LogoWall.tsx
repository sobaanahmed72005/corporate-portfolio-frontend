...
export async function LogoWall() {
  ...
  return (
    <section className="overflow-hidden bg-ink-950 py-14 sm:py-20">
      <Container>
        <p className="mb-8 text-center font-display text-sm font-semibold uppercase tracking-wide text-ink-400">
