  ...
  return (
    <span
      className={cn(
        ...
        dark ? "bg-brand-600 text-white" : "border border-cardText-950/10 bg-card-950 text-cardText-950",
      )}
    >
...
export function TrustTicker() {
  return (
    <div className="overflow-hidden border-t-2 border-pageText-950/15 bg-page-900 py-10">
      <Container>
