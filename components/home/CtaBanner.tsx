...
export function CtaBanner({
  ...
  return (
    <section className="border-t border-pageText-950/10 py-20 sm:py-32">
      <Container>
        <div className="relative overflow-hidden rounded-3xl bg-emerald-700 px-8 py-14 text-center shadow-xl sm:px-14 sm:text-left">
          <div
            className="pointer-events-none absolute inset-0 opacity-20"
            style={{
              backgroundImage:
                "radial-gradient(circle at 15% 30%, white 0, transparent 30%), radial-gradient(circle at 85% 80%, #34D399 0, transparent 35%)",
            }}
            aria-hidden
          />
          <div className="relative flex flex-col items-center gap-6 sm:flex-row sm:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-md text-emerald-50">{description}</p>
            </div>
