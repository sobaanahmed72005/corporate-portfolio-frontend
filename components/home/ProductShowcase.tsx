...
import { FIT_OVERRIDES, SHOP_URL_OVERRIDES, CATEGORY_SHOP_URL_OVERRIDES } from "@/components/products/ProductCard";
            ...
            <div className="relative flex flex-col overflow-hidden rounded-3xl bg-card-950 shadow-sm sm:min-h-[230px] sm:flex-row sm:items-center">
              ...
              <div className="relative flex flex-col items-start gap-3 p-8 pt-0 sm:ml-auto sm:max-w-xs sm:p-10">
                ...
                <div className="w-fit">
                  <GradientPillLink
                    href={safeHref(
                      SHOP_URL_OVERRIDES[featured.slug] ??
                      CATEGORY_SHOP_URL_OVERRIDES[active.slug] ??
                      company.storeUrl
                    )}
                    target="_blank"
